    ...
    <div>
      ...
      >
        ...
        >
          ...
          >
            Coach Dashboard • Feed Management
          </motion.p>
          <motion.h1
            style={{
              ...typography.h1,
          ...
          >
            ...
            <span style={{ display: "block", color: colors.accent.main, fontSize: typography.fontSize.lg, fontWeight: typography.fontWeight.normal, marginTop: spacing.xs }}>
              Review and approve student post requests
            </span>
          </motion.h1>
        </div>
      </motion.section>
      ...
      {loading ? (
        ...
        <Card variant="default" padding="xl" style={{ textAlign: "center" }}>
          <p style={{ color: colors.text.muted, ...typography.body, marginBottom: spacing.md }}>
...
export default CoachPostApprovalPage;
