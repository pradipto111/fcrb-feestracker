...
export const FCRBLoader: React.FC<FCRBLoaderProps> = ({
  isLoading,
      ...
      <div className="fcrb-loader__stage">
        ...
        <div className="fcrb-loader__rays" aria-hidden="true">
          {Array.from({ length: 8 }).map((_, idx) => (
            <span key={idx} style={{ ["--ray-index" as string]: idx } as React.CSSProperties} />
          ))}
        </div>
          ...
          <div className="fcrb-loader__crest-wrap">
            ...
            <div className="fcrb-loader__sunburst">
              {Array.from({ length: 7 }).map((_, idx) => (
                <span key={idx} style={{ ["--sun-index" as string]: idx } as React.CSSProperties} />
              ))}
            </div>
            <img src={crestSrc} alt="" className="fcrb-loader__crest-image" />
          </div>
